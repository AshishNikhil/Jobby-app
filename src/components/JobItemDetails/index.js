...
class JobItemDetails extends Component {
  ...
  formattedData = dataFormate => ({
    companyLogoUrl: dataFormate.company_logo_url,
    companyWebsiteUrl: dataFormate.company_website_url,
    employmentType: dataFormate.employment_type,
    skills: dataFormate.skills,
    id: dataFormate.id,
    jobDescription: dataFormate.job_description,
    packagePerAnnum: dataFormate.package_per_annum,
    rating: dataFormate.rating,
    title: dataFormate.title,
    location: dataFormate.location,
    lifeAtCompany: dataFormate.life_at_company,
  })

  getFormattedData = dataFormate => ({
    companyLogoUrl: dataFormate.company_logo_url,
    employmentType: dataFormate.employment_type,
    id: dataFormate.id,
    jobDescription: dataFormate.job_description,
